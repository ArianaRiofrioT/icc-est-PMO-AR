        ...
        while (true) {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    switch (metodo) {
                        case 1:
                            arreglo = metodos.sortByBubble(arreglo, ascendente);
                            break;
                        case 2:
                            arreglo = metodos.sortBySeleccion(arreglo, ascendente);
                            break;
                        case 3:
                            arreglo = metodos.sortInsertion(arreglo, ascendente);
                            break;
                        case 4:
                            arreglo = metodos.sortBubbleAva(arreglo, ascendente);
                            break;
                        default:
